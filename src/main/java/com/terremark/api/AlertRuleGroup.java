...
public enum AlertRuleGroup {
    ...
    public static AlertRuleGroup fromValue(final String v) {
        for (final AlertRuleGroup c : AlertRuleGroup.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
