...
/**
 * <p>
 * Java class for CreateRole complex type.
 * <p>
...
@XmlType(name = "CreateRole", propOrder = {"name", "active", "roleType", "businessOperations"})
@javax.xml.bind.annotation.XmlRootElement(name = "CreateRole")
public final class CreateRole extends ToStringGenerator {
