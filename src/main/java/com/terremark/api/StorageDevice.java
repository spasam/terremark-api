...
/**
 * <p>
 * Java class for StorageDevice complex type.
 * <p>
...
@XmlType(name = "StorageDevice", propOrder = {"serialNumber", "assignedIpAddresses"})
@javax.xml.bind.annotation.XmlRootElement(name = "StorageDevice")
public final class StorageDevice extends PhysicalDevice {
