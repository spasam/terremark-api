...
@XmlType(name = "CreateHttpMonitor", propOrder = {"requestUri", "httpHeaders", "responseCodes"})
@javax.xml.bind.annotation.XmlRootElement(name = "CreateHttpMonitor")
public final class CreateHttpMonitor extends CreateInternetServiceMonitorRequest {
