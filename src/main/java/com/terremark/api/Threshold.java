...
/**
 * <p>
 * Java class for Threshold complex type.
 * <p>
...
@XmlType(name = "Threshold", propOrder = {"compareType"})
public class Threshold extends ResourceCapacity {
     ...
     */
    public void setCompareType(final String value) {
