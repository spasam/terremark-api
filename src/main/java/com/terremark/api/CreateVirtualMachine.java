...
/**
 * <p>
 * Java class for CreateVirtualMachine complex type.
 * <p>
...
@XmlType(name = "CreateVirtualMachine", propOrder = {"template"})
@javax.xml.bind.annotation.XmlRootElement(name = "CreateVirtualMachine")
public final class CreateVirtualMachine extends CreateOsTemplateVirtualMachineRequest {
