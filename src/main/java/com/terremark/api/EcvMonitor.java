...
/**
 * <p>
 * Java class for EcvMonitor complex type.
 * <p>
...
@XmlType(name = "EcvMonitor", propOrder = {"sendString", "httpHeaders", "receiveString"})
@javax.xml.bind.annotation.XmlRootElement(name = "EcvMonitor")
public final class EcvMonitor extends ConfigurableInternetServiceMonitor {
