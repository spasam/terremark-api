...
/**
 * <p>
 * Java class for VirtualMachines complex type.
 * <p>
...
@XmlType(name = "VirtualMachines", propOrder = {"virtualMachines"})
@javax.xml.bind.annotation.XmlRootElement(name = "VirtualMachines")
public final class VirtualMachines extends ToStringGenerator {
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link VirtualMachineReference }
     */
