...
/**
 * <p>
 * Java class for ComputePools complex type.
 * <p>
...
@XmlType(name = "ComputePools", propOrder = {"computePools"})
@javax.xml.bind.annotation.XmlRootElement(name = "ComputePools")
public final class ComputePools extends ToStringGenerator {
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ComputePoolReference }
     */
