...
/**
 * <p>
 * Java class for PublicIpAddresses complex type.
 * <p>
...
@XmlType(name = "PublicIpAddresses", propOrder = {"publicIps"})
@javax.xml.bind.annotation.XmlRootElement(name = "PublicIpAddresses")
public final class PublicIpAddresses extends ToStringGenerator {
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link PublicIpAddressReference }
     */
