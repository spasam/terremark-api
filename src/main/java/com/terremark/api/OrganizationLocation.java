...
/**
 * <p>
 * Java class for OrganizationLocation complex type.
 * <p>
...
@XmlType(name = "OrganizationLocation", propOrder = {"catalog", "environments"})
public class OrganizationLocation extends Resource {
     ...
     */
    public void setCatalog(final Reference value) {
        this.catalog = value;
    }
