...
/**
 * <p>
 * Java class for AttachDiskRetryOperation complex type.
 * <p>
...
@XmlType(name = "AttachDiskRetryOperation", propOrder = {"detachedDisk", "virtualMachine"})
@javax.xml.bind.annotation.XmlRootElement(name = "AttachDiskRetryOperation")
public final class AttachDiskRetryOperation extends Resource {
