...
/**
 * <p>
 * Java class for PublicIpAddressReference complex type.
 * <p>
...
@XmlType(name = "PublicIpAddressReference", propOrder = {"ipType"})
public class PublicIpAddressReference extends Reference {
     ...
     */
    public void setIpType(final PublicIpTypeEnum value) {
        this.ipType = value;
    }
}
