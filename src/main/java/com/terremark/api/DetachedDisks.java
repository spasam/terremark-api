...
/**
 * <p>
 * Java class for DetachedDisks complex type.
 * <p>
...
@XmlType(name = "DetachedDisks", propOrder = {"detachedDisks"})
@javax.xml.bind.annotation.XmlRootElement(name = "DetachedDisks")
public final class DetachedDisks extends Resource {
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link DetachedDisk }
     */
